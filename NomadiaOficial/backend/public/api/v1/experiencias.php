<?php
// Simple API endpoint to list experiencias for frontend testing (Option 1)
// Reads DB credentials from project's .env when available.
...
// Only show published experiences (published = 1) with guide info
$sql = "SELECT e.*, u.name as guia_nombre, u.foto as guia_foto, u.ubicacion as guia_ubicacion 
        FROM experiencias e 
